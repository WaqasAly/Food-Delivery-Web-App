...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Products - Add Product</h4>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            <textarea type="text" name="name" rows="1" cols="4" class="form-control elastic" placeholder="Enter product Name" required></textarea>
                        </div>
                    </div>
                </div>
            </div><div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            <input type="file" multiple name="file[]" rows="1" cols="4" class="form-control elastic" placeholder="Enter product Name"></input>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            <textarea type="text" name="rating" rows="1" cols="4" class="form-control elastic" placeholder="Enter reviews" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            <textarea type="text" name="price" rows="1" cols="4" class="form-control elastic" placeholder="Enter Price" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            <textarea type="text" name="tqtty" rows="1" cols="4" class="form-control elastic" placeholder="Enter Quantity" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            <textarea type="text" name="threshqtty" rows="1" cols="4" class="form-control elastic" placeholder="Enter Threshold Quantity" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
