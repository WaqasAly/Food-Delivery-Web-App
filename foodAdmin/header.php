                ...
                <div class="sidebar-section">
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-stack-text"></i> <span>Slider</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Slider">
                                <li class="nav-item"><a href="add_banner.php" class="nav-link">Add Banner</a></li>

                                <li class="nav-item"><a href="edit_banner.php" class="nav-link">Edit Banner</a></li>

                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-cabinet"></i> <span>Category</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Themes">
                            <li class="nav-item"><a href="add_category.php" class="nav-link">Add Category</a></li>
                            <li class="nav-item"><a href="edit_category.php" class="nav-link">Edit Category</a></li>
                            </ul>
                        </li>
                        
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-drawer"></i> <span>User</span></a>
                        ...
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-grid4"></i> <span>Products</span></a>
                        ...
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-grid4"></i> <span>View</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Themes">
                                <li class="nav-item"><a href="view_admin.php" class="nav-link">Admin</a></li>
                                <li class="nav-item"><a href="view_customers.php" class="nav-link">Customer</a></li>
                                <li class="nav-item"><a href="view_delivery_man.php" class="nav-link">Delivery Man</a></li>
                            </ul>
                        </li>
                        <!-- /page kits -->
