...
include("header.php");
$query = "SELECT * FROM credentials WHERE person = 'customer'";
$customers = db::getRecords($query);
?>
<script>
...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - View - customer
            </h4>
        </div>
    </div>
