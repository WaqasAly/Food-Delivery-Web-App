...
<section class="newsletter mb-15 wow animate__animated animate__fadeIn">
    <?php
        ...
        $cats = categoryCRUD::getAllCategories();
    ?>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            ...
                            <img src="assets/imgs/banner/banner-9.png" style = " width : 400px ; height: 400px " alt="newsletter" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            <ul class="contact-infor">
                                <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>Department of Computer Science - UET Lahore</span></li>
                                <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>(+92)-334-8076605</span></li>
                                <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span><a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="780b19141d38361d0b0c561b1715">waqasghani14@gmail.com</a></span></li>
                    ...
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        ...
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            ...
                            foreach($cats as $cat)
                            {
                                echo '<li><a href="shopList.php?category='.$cat->getId().'">'.$cat->getCategoryName().'</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; 2022, <strong class="text-brand">FoodBear</strong> - Made by ❤️ <br />All rights reserved</p>
                </div>
